...
def main():
    parser = argparse.ArgumentParser(
        description="Train all medical imaging datasets with shared settings."
    )
    ...
    parser.add_argument(
        ...
        "--datasets",
        nargs="+",
        default=MEDICAL_IMAGING_DATASETS,
        help="Medical imaging datasets to train. Defaults to all supported ones.",
    )
